...
<div class="wrapper">
                        ...
                        <div class="pull-left">
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    ...
                                    <button type="button" class="btn btn-default" onclick="window.location.reload();" title="刷新" ><i class="fa fa-refresh"></i> 刷新</button>
                                </div>
                            </div>
                        </div>
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2019-2020 <a href="http://www.itcast.cn">fogyyyyyy</a>.</strong> All rights reserved.
    </footer>
    <!-- 底部导航 /-->
